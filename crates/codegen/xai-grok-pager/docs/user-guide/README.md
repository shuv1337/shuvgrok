...
Learn how to install, configure, and extend ShuvGrok, the terminal-based AI coding assistant from SpaceXAI.
...
Automate, script, and integrate ShuvGrok with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `shuvgrok -p`, output formats, CI/CD integration, and piping |
